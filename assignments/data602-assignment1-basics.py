...
def exercise02():
    ...
    # ------ Place code below here \/ \/ \/ ------
    name = "Chinedu" # Assigns my first name to the variable name
    # ------ Place code above here /\ /\ /\ ------
...
def exercise03():
    ...
    # ------ Place code below here \/ \/ \/ ------
    sentence = "This is Python" # The variable sentence holds the string "This is Python"
    # ------ Place code above here /\ /\ /\ ------
...
def exercise04():
    ...
    # ------ Place code below here \/ \/ \/ ------
    first_name = "Chinedu" # Assigns my first_name to the variable first_name
    last_name = "Onyeka" # Assigns my last_name to the variable last_name
    # ------ Place code above here /\ /\ /\ ------
...
def exercise06():
    ...
    hours_worked = 20
    wage_per_hour = 15
    total_pay = hours_worked * wage_per_hour # Calculate the total pay
    # ------ Place code above here /\ /\ /\ ------
...
def exercise08():
    ...
    quantity = 5
    hello = "hello"
    hello_repeated = hello * quantity # hello repeated quantity
    # ------ Place code above here /\ /\ /\ ------
...
def exercise09():
    ...
    qty = 10
    price = 5
    total_cost = qty * price # computes the total cost
    # ------ Place code above here /\ /\ /\ ------
...
def exercise10():
    ...
    factor4 = 4
    factor5 = 5
    product = factor1 * factor2 * factor3 * factor4 * factor5 # computes product of all five factors
    # ------ Place code above here /\ /\ /\ ------
...
def exercise11():
    ...
    # ------ Place code below here \/ \/ \/ ------
    pi = 3.1415926535 # the value of pi to 10 decimal places
    # ------ Place code above here /\ /\ /\ ------
    return pi
...
def exercise12():
    ...
    # ------ Place code below here \/ \/ \/ ------
    x = 10
    y = x ** 7 # x raised to the 7th power
    # ------ Place code above here /\ /\ /\ ------
    return x, y
...
def exercise13():
    ...
    # ------ Place code below here \/ \/ \/ ------
    r = 7
    volume_sphere = (4 / 3) * pi * (r**3) # calculates the volume of a sphere
    # ------ Place code above here /\ /\ /\ ------
...
def exercise15():
    ...
    # ------ Place code below here \/ \/ \/ ------
    speed_mph = 80 # speed in miles per hour
    duration = 3 # duration in hours
    distance = speed_mph * duration # calculates distance in miles
    # ------ Place code above here /\ /\ /\ ------
...
def exercise16():
    ...
    a = 3
    b = 4
    c = math.sqrt(a**2 + b**2) # Pythagoras theorem c2 = a2 + b2
    # ------ Place code above here /\ /\ /\ ------
    return a, b, c
